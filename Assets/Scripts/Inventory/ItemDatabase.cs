...
namespace Assets.Scripts.Inventory
{
	public class ItemDatabase : MonoBehaviour {
		...
		void Start () {
            ...
            Items.Add(new Weapon("Bow of Bowling", 3, "This bow was made by an alcoholic blacksmith. Not a good bow.", 1, Weapon.WeaponTypeDefines.Ranged, 12, "tileground", "8_bit_sword_by_xxx515xxx-d4lyhdi", new Vector3(30, 30)));
		}
